...
__all__ = ['merge_small_images']


def resize_by_width(infile, image_size=1024):
    """按照宽度进行所需比例缩放"""
...
def merge_small_images(image_dir_path, image_save_name, image_save_path, image_size=1024, image_colnum=2):
    # 获取图片集地址下的所有图片名称
    ...
    image_save_path = r'{}/{}.jpg'.format(image_save_path, image_save_name)  # 图片转换后的地址
